...
public class Ox extends Animals implements Ianimals {
	Random myRandom = new Random();

	AnimalOwner owner = new AnimalOwner(null, null, 0, 0, 0);

//	constructor to set the Attributes.
	public Ox(int idAnimal, String name, int age, String species, String gender, String medicalCond,
			AnimalOwner owner) {
...
//	instantiate the graphical and UserInteraction methods to print some interactions.
	...
	public void sounds() {
		...
		printer.typeWriter("Muuuuuu,  Muuuuu.", 50);
	}
