...
public class StaffSearch {
	...
	public void SearchStaff() {
		query.YesOrNo(4, "\n\n\n Would you like to search for an espesifc type of data related to staff?  \n\n type Yes or No.");
		// chose a option
				if (query.getUserYesOrNoValidOptio() == 1) {
					query.MultipleChoise(3, "\n \n Grand. \nPlease choose the type of search written bellow: \n"
							...
							+ "\n" + "    \n\n 2 - TITLE: " + "\n\n"
							+ "             |                  Here you can search for a title and will return all the staff in the list from the fuction you chose.                      |"
							+ "\n" + "    \n\n 3 - NAME: " + "\n\n"
