	...
	public void SearchStaff() {
		...
		if (query.getUserYesOrNoValidOptio() == 1) {
			query.MultipleChoise(3, "\n \n Grand. \nPlease choose the type of search written bellow: \n\n\n"
					...
					+ "\n" + "    \n\n 2 - TITLE: " + "\n\n"
					+ "             |                  Here you can search for a title and it will return all the staff in the list from the function you choose.                      |"
					+ "\n" + "    \n\n 3 - NAME: " + "\n\n"
					+ "             |                  Here you can search for a specify name and it will return all the staff in the list with the same name you choose.             |"
					+ "\n\n"
			...
			if (query.getUserMultipleChoiseValidOption() == 1) {
				query.OnlyString(3, "\n Please type the ID you are looking for: \n");
...
//		            	  would be possible implement a method similar to YesOrNo and check all the title names to case sensitive BUT we don't afford the time to do it. 
				query.OnlyString(3, "\n Please type the title you are looking for: "
				...
				query.OnlyString(3, "\\n Please type the name you are looking for: \"\r\n"
						+ "						+ \"\\n\\n  *BE AWARE* I will put some faith that you will type the title exactly as it shown in your device. Otherwise no deal for you. :\\n\\n");
